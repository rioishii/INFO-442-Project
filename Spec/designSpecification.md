...
## Solution
&nbsp;&nbsp;&nbsp;&nbsp;Our solution will be in the form of a responsive web application in order to appeal to a diverse audience. This will include popular operating systems such as Android, iOS, and Windows. This web application will take on modern design principles, such as the mobile-first design approach, to ensure that this application caters towards accessibility and ease of access. This solves the problem of tolerance threshold by showing the unfair workload between roommates. By being able show visualizations quickly who doesn't do as much work as others, people with a low tolerance threshold can make a good argument against those with a high tolerance threshold. The solution will give understanding for those with a high tolerance threshold to those with a low tolerance threshold. Thus, being able to see eye-to-eye, all roommates will try to equalize the workload of chores.
